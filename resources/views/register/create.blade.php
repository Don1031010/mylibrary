...
<section class="px-6 py-8">
    ...
    <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
        ...
        <form method="POST" action="/register" class="mt-10">
            @csrf
            <div class="mb-6">
                <label for="" class="block mb-2 uppercase font-bold text-xs text-gray-700" for="name">Name</label>
            ...
            <div class="mb-6">
                <label for="" class="block mb-2 uppercase font-bold text-xs text-gray-700" for="username">Username</label>
            ...
            <div class="mb-6">
                <label for="" class="block mb-2 uppercase font-bold text-xs text-gray-700" for="email">email</label>
            ...
            <div class="mb-6">
                <label for="" class="block mb-2 uppercase font-bold text-xs text-gray-700" for="password">Password</label>
